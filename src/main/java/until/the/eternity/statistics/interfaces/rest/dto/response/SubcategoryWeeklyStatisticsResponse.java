...
@Schema(description = "서브카테고리별 주간 통계 응답")
public record SubcategoryWeeklyStatisticsResponse(
        ...
        @Schema(description = "거래 총량 (총 거래 금액)", example = "350000000") Long totalVolume,
        @Schema(description = "거래 수량 (itemCount 합계)", example = "10500") Long totalQuantity,
