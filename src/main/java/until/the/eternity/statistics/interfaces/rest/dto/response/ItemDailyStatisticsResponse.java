...
@Schema(description = "아이템별 일간 통계 응답")
public record ItemDailyStatisticsResponse(
        ...
        @Schema(description = "거래 총량 (총 거래 금액)", example = "5000000") Long totalVolume,
        @Schema(description = "거래 수량 (itemCount 합계)", example = "150") Long totalQuantity,
