...
@Schema(description = "아이템별 주간 통계 응답")
public record ItemWeeklyStatisticsResponse(
        ...
        @Schema(description = "거래 총량 (총 거래 금액)", example = "35000000") Long totalVolume,
        @Schema(description = "거래 수량 (itemCount 합계)", example = "1050") Long totalQuantity,
