...
public final class CacheKeyBuilder {
    ...
    public static String buildAuctionHistorySearchKey(
        ...
        return pageable.getPageNumber()
                ...
                + ":"
                + resolveExactItemName(requestDto.isExactItemName())
                + ":"
    ...
    private static boolean resolveExactItemName(Boolean isExactItemName) {
        return isExactItemName == null || isExactItemName;
    }
}
