...
@Schema(description = "서브카테고리별 일간 통계 응답")
public record SubcategoryDailyStatisticsResponse(
        ...
        @Schema(description = "거래 총량 (총 거래 금액)", example = "50000000") Long totalVolume,
        @Schema(description = "거래 수량 (itemCount 합계)", example = "1500") Long totalQuantity,
